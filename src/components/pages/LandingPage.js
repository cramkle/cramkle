...
const LandingPage = () => (
  <div className="bg-primary c-on-primary flex flex-column flex-row-l pa3 justify-around items-center vh-100 w-100">
    <div>
      <h1 className="mdc-typography--headline2 b">
        Cramkle
      </h1>
      <h2 className="mdc-typography--headline4 mv4 mv0">
        Make sure your knowledge will last
      </h2>
    </div>
    <div className="inline-flex flex-column items-center w-100" style={{ maxWidth: 450 }}>
