...
const StyleButton: React.FunctionComponent<Props> = ({
  ...
  const className = classNames(
    'mdc-ripple-surface flex-shrink-0 text-primary bg-surface relative cursor-pointer mr-2 border-0 border-none rounded-sm flex items-center text-center outline-none p-1',
    {
