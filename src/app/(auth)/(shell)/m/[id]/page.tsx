...
import DeleteModelButton from '@src/components/DeleteModelButton'
import EditFieldsDialog from '@src/components/EditFieldsDialog'
import { EditModelButton } from '@src/components/EditModelButton'
import EditTemplatesDialog from '@src/components/EditTemplatesDialog'
...
import { OverflowMenuIcon } from '@src/components/icons/OverflowMenuIcon'
...
import {
  ...
  MenuItem,
  MenuList,
} from '@src/components/views/MenuButton'
import {
  Tab,
  TabList,
  TabPanel,
  TabPanels,
  Tabs,
} from '@src/components/views/Tabs'
import {
  Body1,
  Body2,
  Headline1,
