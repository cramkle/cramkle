...
import FlashCardRenderer from '@src/components/FlashCardRenderer'
import FlashCardStatus from '@src/components/FlashCardStatus'
import PersistedEditor from '@src/components/editor/PersistedEditor'
import { Button } from '@src/components/views/Button'
import { Card } from '@src/components/views/Card'
import { Checkbox } from '@src/components/views/Checkbox'
import { Container } from '@src/components/views/Container'
import { Dialog } from '@src/components/views/Dialog'
import { Divider } from '@src/components/views/Divider'
import {
  Table,
  TableBody,
  TableCell,
  TableHead,
  TableRow,
} from '@src/components/views/Table'
import { Caption, Headline1, Headline2 } from '@src/components/views/Typography'
...
export default function NotePage({
  ...
  const { data, loading } = useQuery<NoteQuery, NoteQueryVariables>(
    NOTE_QUERY,
    { variables: { noteId: decodeURIComponent(noteId) } }
  )
